...
_, ANNUAL_PRODUCTION = si.read_pvwatts("input/pvwatts_hourly.csv")  # kWh/yr
...
c[0], c[1], c[2] = (
    (-ARRAY_COST + P_RETAIL_COST * ANNUAL_PRODUCTION),
    (-ARRAY_COST + P_WHOLESALE_COST * ANNUAL_PRODUCTION),
    -BATTERY_COST,
)
